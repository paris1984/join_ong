...
import es.pjd.data.model.administratorvolunteer.AdministratorVolunteer;
...
import es.pjd.data.state.factory.StateFiledFormAdministratorVolunteerFactory;

public class AdministratorVolunteerRegViewModel extends BaseViewModel<AdministratorVolunteer> {
    ...
    public AdministratorVolunteerRegViewModel() {
